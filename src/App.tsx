...
function CataloguePage({clients,lang,isMobile}:any){
  ...
  const generateDraftQuote=async()=>{
    ...
    const linesHtml=validLines.map((l:any)=>[
      "<tr>",
      '<td style="padding:6px 10px;border:1px solid #DBEAFE;font-size:11px">'+l.pn+"</td>",
      '<td style="padding:6px 10px;border:1px solid #DBEAFE;font-size:11px">'+(l.desc||"—")+"</td>",
      '<td style="padding:6px 10px;border:1px solid #DBEAFE;font-size:11px;text-align:right">'+(+l.unitPrice||0).toLocaleString("fr-FR",{minimumFractionDigits:2})+"</td>",
      '<td style="padding:6px 10px;border:1px solid #DBEAFE;font-size:11px;text-align:center">'+l.qty+"</td>",
      '<td style="padding:6px 10px;border:1px solid #DBEAFE;font-size:11px;text-align:right">'+((+l.qty||0)*(+l.unitPrice||0)).toLocaleString("fr-FR",{minimumFractionDigits:2})+"</td>",
      '<td style="padding:6px 10px;border:1px solid #DBEAFE;font-size:11px;color:#6B7280">'+(l.avail||"")+"</td>",
      "</tr>"
    ].join("")).join("");
    const th=(txt:string,align:string="left",w2:string="")=>
      '<th style="padding:7px 10px;border:1px solid #93C5FD;font-size:11px;text-align:'+align+';font-weight:bold'+(w2?";width:"+w2:"")+'">'+txt+"</th>";
    const parts=[
